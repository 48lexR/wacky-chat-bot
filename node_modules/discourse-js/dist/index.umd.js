(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global.DiscourseJS = {}));
    ...
    ***************************************************************************** */
    ...
    })(exports.PostActions || (exports.PostActions = {}));
    ...
    function Posts(discourse) {
        ...
        this.like = function (_a) {
            var id = _a.id;
            return _this.postAction({ body: { id: id, post_action_type_id: exports.PostActions.Like } });
        };
        this.unlike = function (_a) {
            var id = _a.id;
            return _this.postAction({
                method: 'delete',
                body: { post_action_type_id: exports.PostActions.Like },
                id: id,
            });
        };
                ...
                return fetch(_this._BASE_URL + "/" + path, fetchOptions)
                    ...
                    if (response.ok) {
                        if (contentType && contentType.indexOf('application/json') !== -1) {
                            return response.json().then(humps.camelizeKeys);
                        }
                        else {
                            /**
